...
contract('testDogeTokenDoUnlock2', function(accounts) {
  ...
  it('doUnlock whith multiple utxos', async () => {
    ...
    var unlockPendingInvestorProof = await dogeToken.getUnlockPendingInvestorProof(1);
    ...
    var unlockPendingInvestorProof = await dogeToken.getUnlockPendingInvestorProof(2);
