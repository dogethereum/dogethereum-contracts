...
contract('DogeClaimManager', (accounts) => {
  ...
  const genesisHeader = ``;
  const headers = [
  ...
  const genesisSuperblock = utils.makeSuperblock([genesisHeader], initParentId, initAccumulatedWork);
  ...
  describe('Confirm superblock after timeout', () => {
    ...
    it('Propose fork', async () => {
      const proposedSuperblock = utils.makeSuperblock([headers[0]], genesisSuperblock.superblockId, genesisSuperblock.accumulatedWork);
      const result = await claimManager.proposeSuperblock(
        proposedSuperblock.merkleRoot,
        proposedSuperblock.accumulatedWork,
        proposedSuperblock.timestamp,
  ...
  describe('Challenge superblock', () => {
    ...
    hashes.forEach((hash, idx) => {
      it(`Query blocks header ${hash.slice(0, 20)}..`, async () => {
        const result = await claimManager.queryBlockHeader(session1, hash, { from: challenger });
        assert.equal(result.logs[0].event, 'QueryBlockHeader', 'Query block header');
      });
  ...
  describe('Challenge timeouts', () => {
    ...
    const beginNewChallenge = async () => {
      ...
      // Propose
      const proposeSuperblock = utils.makeSuperblock([headers[0]], genesisSuperblock.superblockId, genesisSuperblock.accumulatedWork);
