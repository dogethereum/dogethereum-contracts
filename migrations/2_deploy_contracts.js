...
module.exports = function(deployer, network, accounts) {
  ...
  if (network === 'development') {
    ...
    return deployer.deploy(DogeRelayForTests, dogeRelayNetwork, {gas: 4600000}).then(function () {
      ...
      return deployer.deploy(DogeTokenForTests, DogeRelayForTests.address, dogethereumRecipient, {gas: 4400000});
    }).then(function () {
    ...
    return deployer.deploy(DogeRelay, dogeRelayNetwork, {gas: 3600000}).then(function () {
      return deployer.deploy(DogeToken, DogeRelay.address, dogethereumRecipient, {gas: 4200000});
    }).then(function () {
