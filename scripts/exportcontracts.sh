...
/home/cat/software/web3j-3.3.1/bin/web3j truffle generate ~/dogethereum-contracts/build/contracts/DogeBattleManager.json -o ~/agent/src/main/java/ -p org.dogethereum.dogesubmitter.contract